...
def featuresToGPX(inputFC, outGPX):
...
def generatePointsFromFeatures(inputFC, descInput):
    ...
    def attHelper(row):
        ...
        valuesDict["Descript"] = row[fieldNameDict["Payam"]] if "Payam" in fields else " "
    ...
    fieldNameDict = {"Elevation": 0, "Name": 1, "Payam": 2, "DateTime": 3, "Type": 4, "SRC_LON": 5, "SRC_LAT": 6}
